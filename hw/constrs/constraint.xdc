...
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { rx_done_tick_o }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { tx_done_tick_o }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
##Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { sw_i }]; #IO_L9P_T1_DQS_14 Sch=btnc
